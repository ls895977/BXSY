                ...
                rxPermissions
                        ...
                        .subscribe(new Consumer<Boolean>() {
                            ...
                            public void accept(Boolean aBoolean) throws Exception {
                                if (aBoolean) {
                                    Album.album(getActivity()) // 图片和视频混选。
//
                                            .singleChoice()
...
//                        .multipleChoice() // 多选模式，单选模式为：singleChoice()。
    ...
    private void doCreateCommunity(List<File> files) {
        HttpNetWorkUtils.uploadCreateCommunity(this, editCommunityName.getText().toString(), editCommunityNote.getText().toString(), myAdCode, myAddress, mySimpleAddress, myLngtitude + "", myLatitude + "", MyApplication.getCurrentUserInfo().getUserId(), files, myHandler);
    }
