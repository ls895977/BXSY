...
public class CommunityRequestListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (isJoin) {
            holder.tv_requestContent.setText(requestLists.get(position).getUserId() + "请求加入服务号");
        } else {
    ...
    private void dealJoinRequest(String requestId, String communityId, String addType) {
        ReqCommunity.dealJoinRequest(context, "adapter", MyApplication.getCurrentUserInfo().getUserId(), requestId, communityId, addType, new EntityCallBack<BaseResp>() {
            @Override
    ...
    private void dealManagerRequest(String requestId, String communityId, String addType) {
        ReqCommunity.dealSuperRequest(context, "adapter", MyApplication.getCurrentUserInfo().getUserId(), requestId, communityId, addType, new EntityCallBack<BaseResp>() {
            @Override
            public Class<BaseResp> getEntityClass() {
                return BaseResp.class;
            }
