package com.maoyongxin.myapplication.ui.fgt.community.act.groupchatdetailnew.fgt.act.test;
...
public class DynamicFragment extends LazyFragment {
    ...
    public void lazyInitView(View view, Bundle savedInstanceState) {
        ...
        recyclerView.addItemDecoration(new NormalDecoration(ContextCompat.getColor(mActivity, R.color.mainGrayF8), (int) mActivity.getResources().getDimension(R.dimen.dip_10)));
