...
public class Act_new_comment extends Activity   {
    ...
    private List<com.maoyongxin.myapplication.http.entity.new_comment> huifuInfoList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Getrepeat();
        commentAdapter=new comment_recycle_groupList( huifuInfoList,Act_new_comment.this);
        ...
        recyclerView.addOnScrollListener(new EndLessOnScrollListener(mLinearLayoutManager) {
            ...
            public void onLoadMore(int currentPage) {
                ...
                {
                    Toast.makeText(Act_new_comment.this,"没有数据了",Toast.LENGTH_SHORT).show();
                }
                ...
                try{
                    ...
                    if(data.getInt("code")==200)
                    {
                        for(int i=0;i<commList.length();i++)
                        {
                            ...
                            com.maoyongxin.myapplication.http.entity.new_comment newComment=new com.maoyongxin.myapplication.http.entity.new_comment();
