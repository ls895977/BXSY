...
import com.maoyongxin.myapplication.tool.ImageUtils;
...
public class act_business_detailEdit extends BaseAct {
    ...
    public int initLayoutId() {
        return R.layout.activity_act_business_detail_edit;
    }
    ...
    public void initView() {
        ...
        et_new_content = getView(R.id.et_business_intro);
        setOnClickListener(R.id.friends_back);
        setOnClickListener(R.id.fabu);
        setOnClickListener(R.id.addBusinessImage);
    ...
    public void initData() {
        ...
        if (aCache.getAsString("noteContent") != null) {
                    showDataSync(aCache.getAsString("noteContent"));
        }
    }
    ...
    public void onViewClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.fabu://发布
                commitData();
                break;
            case R.id.addBusinessImage://添加图片
...
//                content.append(itemData.inputStr);
    ...
    public void commitData() {
        ...
        Intent i = new Intent();
        i.putExtra("content", UtilsTool.addByte64(getEditData()));
        i.putExtra("img", imageBean.getUrl().get(0));
    ...
    protected void onDestroy() {
        super.onDestroy();
        String noteContent = getEditDataAva();
            aCache.put("noteContent", noteContent);
    }
    /**
     * 获取没有改变的html格式数据
      * @return
     */
    private String getEditDataAva() {
        List<RichTextEditor.EditData> editList = et_new_content.buildEditData();
     ...
     * 显示数据
     */
    protected void showEditData1(ObservableEmitter<String> emitter, String html) {
        try{
