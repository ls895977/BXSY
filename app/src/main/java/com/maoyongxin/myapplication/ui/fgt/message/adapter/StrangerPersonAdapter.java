...
public class StrangerPersonAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SelectableRoundedImageView SelectableRoundedImageView= v.findViewById(R.id.img_stranger_header);
    ...
    private void doLike(String personId, String userName) {
        ReqAddFollow.addFollow(context, "adapter", MyApplication.getCurrentUserInfo().getUserId(), personId, userName, new EntityCallBack<FollowResponse>() {
            @Override
        ...
        ReqCommunity.getMyCommunity(context, "adapter", userId, new EntityCallBack<MyCommunityResponse>() {
            ...
            public void onSuccess(MyCommunityResponse resp) {
                if (resp.is200()) {
                    ...
                    holder.tv_xiaoqu.setText("未加入服务号");
                }
            }
