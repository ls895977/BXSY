...
public class comment_recycle_groupList extends RecyclerView.Adapter<comment_recycle_groupList.MyHolder> {
    ...
    private List<com.maoyongxin.myapplication.http.entity.new_comment> list = null;
    ...
    public comment_recycle_groupList(List<com.maoyongxin.myapplication.http.entity.new_comment> list, Context context) {
        ...
        viewHolder.all_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (list.get(position).getCommentType()) {
                    case "1":
                        Intent intent=new Intent(context,Act_DynamicDetail.class);
                    ...
                    case "2":
                        ...
                        Intent intent2=new Intent(context,Act_TopicDetails.class);

                        intent2.putExtra("id",list.get(position).getCommentId());//话题id
                        intent2.putExtra("Groupid",list.get(position).getGroup_id());
                        intent2.putExtra("parentUserId",list.get(position).getParentuserId());
                        intent2.putExtra("groupName", list.get(position).getCommunityName());
                        intent2.putExtra("gambit_id",list.get(position).getCommentId());
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View view) {
            super(view);
             ...
             huifu_content = (EmojiconTextView) view.findViewById(R.id.tv_huifu_parent);
