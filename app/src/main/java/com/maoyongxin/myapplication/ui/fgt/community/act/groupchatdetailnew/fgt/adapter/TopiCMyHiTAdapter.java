...
public class TopiCMyHiTAdapter extends RecyclerView.Adapter<TopiCMyHiTAdapter.MyHolder> implements ShareDialogFragment.Listener {
    List<HuatiInfo1.InfoBean.DataBean> list;
    Context context;
    LayoutInflater inflater;
    String groupName, Groupid, groupimg;

    public TopiCMyHiTAdapter(List<HuatiInfo1.InfoBean.DataBean> list, Context context, String groupName1, String Groupid1, String groupimg1) {
        this.list = list;
...
//                context.startActivity(intent);
        ...
        if (itme.getUid().equals(MyApplication.getCurrentUserInfo().getUserId())) {
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        public MyHolder(View view) {
            ...
            img_userHead = (RoundedImageView) view.findViewById(R.id.img_huatiuser_head);
